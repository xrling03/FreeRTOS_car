...
#黄色区域色块阈值：
#saidao_lab = [(58, 72, -20, 8, 2, 31)]
saidao_lab = [(59, 68, -9, 4, 3, 25)]
saidao_lab_2 = [(100,255)]
#物料阈值：
wuliao_lab = [(12, 56, 13, 44, 1, 25),
              (19, 56, -41, -11, -21, 16),
              (10, 61, -12, 13, -40, -4)]
#物料阈值：
