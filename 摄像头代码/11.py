...
def GetLine(img, comm):
    global LineData
    # LineData=[0,0,0,0]
    line_blob0 = img.find_blobs(saidao_lab_2, x_stride=10, y_stride=10,area_threshold=100)
...
def GetYuan(img, comm):
    ...
    center_y=0
    # Yuanxy=[0,0,0,0] 
    c=img.find_circles(threshold=6000, r_margin=5,r_min=20, r_max=45, r_step=1)
    '''
    for c1 in c:
